/*
 * 3. Se tiene la siguiente información de n personas: dni, apellidos, nombres, sexo, edad y peso. 
Esta información se tiene que registrar en un ArrayList, buscar una persona dado el dni, eliminar una persona,
ordenar por apellidos y mostrar todas las personas. Hacer un menú para realizar lo que se pide.
 */
package ejercicio3;
