/*
 * 1. Crear un programa que use ArrayList de números reales. El programa debe permitir mostrar un menú donde se pueda
 *agregar un número, buscar un número, modificar un número, eliminar un número e insertar un número en una posición dada
 */
package ejercicio1;
